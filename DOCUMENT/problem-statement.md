...
- Every hour of undetected congestion risk compounds: one delayed vessel cascades into berth conflicts for every vessel scheduled after it (see `06_ml_engineering.md` for how PortPulse models this cascade explicitly).
